...
SECRET_KEY = 'django-insecure-^3jbz^@2&ub-cuj^)d9(-9%yb_&zux3&6cnnw15!uf6uv$bpx*'
...
EMAIL_HOST_USER = 'nadin0290'  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо писать user, иными словами, это всё то что идёт до собаки
EMAIL_HOST_PASSWORD = 'ryapolova1990'  # пароль от почты
